...
import com.bignerdrunch.android.suspendseilingcalculator.Dialogs.ImageDialog;
...
import static com.bignerdrunch.android.suspendseilingcalculator.Materials.CONCRETE;
...
public class CardSetFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       if (mCd60.getCdCountOf4Size().getCount()==0){
        ...
        screwPanelCardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDialog(ImageDialog.getNewInstance(detailToString(mScrewPanel), R.string.title_screw_panel, R.drawable.screw_panel));
            }
        });
   ...
   public  String detailToString (Detail detail) {
    ...
    private String createMessage(){
        CalculationMessageCreater messageCreater = new CalculationMessageCreater(mSuspendCeiling);
